...
const testimonials = [
  ...
  },
  {
    ...
    rating: 5,
    text: 'Our family vacation was magical thanks to Stay Wise Miami. The villa had everything we needed, and the private pool was a hit with the kids. Truly a home away from home.',
