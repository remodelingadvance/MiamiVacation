...
const AdminPropertyForm = () => {
  ...
  const {
    ...
    defaultValues: {
      ...
      'location.zipCode': '',
      'location.coordinates': [-80.1300, 25.7800],
      'details.bedrooms': 1,
      'details.bathrooms': 1,
      'details.maxGuests': 2,
      'details.size': '',
      ...
      'pricing.cleaningFee': '',
      'pricing.serviceFee': '',
      'pricing.taxRate': 13.5,
      'pricing.minimumStay': 2,
      'pricing.weeklyDiscount': '',
      'pricing.monthlyDiscount': '',
      'houseRules.checkIn': '15:00',
      'houseRules.checkOut': '11:00',
    ...
    try {
      ...
      const propertyData = {
        ...
        details: {
          ...
          size: data['details.size'] ? parseInt(data['details.size']) : undefined,
          floor: data['details.floor'] ? parseInt(data['details.floor']) : undefined,
          parking: parseInt(data['details.parking']),
        },
        pricing: {
          ...
          taxRate: parseFloat(data['pricing.taxRate']),
          minimumStay: parseInt(data['pricing.minimumStay']),
